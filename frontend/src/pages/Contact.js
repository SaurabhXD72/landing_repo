...
const Contact = () => {
  // Move cooldown state INSIDE the component
  ...
  const handleSubmit = async (e) => {
    ...
    // Block submit if cooldown is active
    if (cooldown) {
      toast.error("AYY TF?!?!?! I see what you're doing. Chill out, spammer.");
      return;
    }
    ...
    if (formData.botField && formData.botField.trim() !== '') {
    ...
    try {
      ...
      // 👇 Enable cooldown after successful send
      setCooldown(true);
      setTimeout(() => setCooldown(false), 10000); // 10 sec cooldown
      ...
      // 👇 Optional: cooldown on failure too (to stop spammers)
      setCooldown(true);
          ...
          <div className="bg-slate-800/50 rounded-xl p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                ...
                className={`w-full px-6 py-3 text-slate-900 font-semibold rounded-lg transition-all duration-200 ${
                  loading || cooldown
                    ? 'bg-amber-300 opacity-50 cursor-not-allowed'
                    : 'bg-amber-400 hover:bg-amber-300 transform hover:scale-[1.02] active:scale-[0.98]'
                }`}
              >
                {loading ? (
            ...
            <div className="bg-slate-800/50 rounded-xl p-8">
              ...
              <div className="space-y-4">
                <div className="flex items-center">
                  ...
                  <a href="mailto:sddeshmukh1007@gmail.com" className="text-slate-300 hover:text-amber-400 transition-colors">
                    Gmail
                  </a>
                </div>
                <div className="flex items-center">
                  ...
                  <a href="https://www.linkedin.com/in/saurabh72" target="_blank" rel="noopener noreferrer" className="text-slate-300 hover:text-amber-400 transition-colors">
                    LinkedIn Profile
                  </a>
                </div>
                <div className="flex items-center">
                  ...
                  <a href="https://github.com/SaurabhXD72" target="_blank" rel="noopener noreferrer" className="text-slate-300 hover:text-amber-400 transition-colors">
                    GitHub Profile
                  </a>
                </div>
              </div>
